...
switch ($tipo_verificacao) {
    ...
    case 1:
        ...
        for ($i = 0; $i < 8; $i++) {
            ...
            if ($pos === false) {
                ...
                echo "Endereço Válido<br>";
                echo "Encontrada na posição $pos";
                $valid = 1;
            }
        }
    ...
    case 2:
        ...
        if (strtolower($mostrar['Email']) == strtolower($email) || $mostrar['CNPJ'] == $cnpj) {
            ...
            //echo "Email ou CNPJ ja cadastrados";
        ...
        if ($val == 0) {
            ...
            if ($digitoum != $cnpj[12] || $digitodois != $cnpj[13]) {
                ...
                //echo "CNPJ Inválido ERRO 3";

            } else {

                //CNPJ VALIDO
                //echo "CNPJ válido<br> $digitoum-$digitodois";
