<footer>
    ...
    <div id = "FooterContent">
        ...
        <ul class = "FooterLicense">
            ...
            <li>
                Todos os direitos reservados. Licenciado por Creative Commons. APE Group <script type = "text/javascript"> var ano = new Date(); document.write(ano.getFullYear()); </script>.
            </li>
