...
$Documentos = $func->DocumentosRecente($id_empresa);
$Acessorios = $func->AcessoriosRecente($id_empresa);
$Roupas = $func->RoupasRecente($id_empresa);
$Eletronicos = $func->EletronicosRecente($id_empresa);
$Outros = $func->OutrosRecente($id_empresa);
