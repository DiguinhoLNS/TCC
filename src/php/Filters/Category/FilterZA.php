...
$Documentos = $func->DocumentosZA($id_empresa);
$Acessorios = $func->AcessoriosZA($id_empresa);
$Roupas = $func->RoupasZA($id_empresa);
$Eletronicos = $func->EletronicosZA($id_empresa);
$Outros = $func->OutrosZA($id_empresa);
